  ...
  const steps = [
    {
      ...
      bg: 'bg-white',
      text: 'text-slate-900',
      tagColor: 'text-[var(--color-primary)]',
      ...
      <header className="flex justify-between items-center z-10 relative mb-3.5 lg:mb-5 shrink-0">
        ...
        >
          ...
          <h1 className="text-[14px] font-black tracking-[0.2em] text-gray-800 uppercase mt-0.5 flex items-center">
            ...
            <span className="group-hover:text-[var(--color-primary)] transition-colors">PHASE 01 / ONLINE SURVEY</span>
          </h1>
        </div>
        ...
        <div className="flex-[1.35] xl:flex-[1.4] flex flex-col min-w-0 pr-0 lg:pr-3.5 xl:pr-5 border-r-0 lg:border-r border-slate-100 min-h-0 overflow-hidden">
          ...
          <div className="flex items-center justify-between bg-slate-50/70 p-2.5 lg:p-3 rounded-lg border border-slate-100 mb-2 lg:mb-2.5 shrink-0">
             <div className="flex flex-col">
               <span className="text-[11px] text-slate-400 font-bold mb-0.5">定向发放</span>
               <span className="text-lg font-black text-slate-400">420</span>
             </div>
             <div className="flex-1 px-3 flex flex-col items-center">
               <span className="text-[11px] font-bold text-slate-400 mb-0.5">回收 74.3%</span>
             ...
             <div className="flex flex-col">
               <span className="text-[11px] text-slate-500 font-bold mb-0.5">完成提交</span>
               <span className="text-xl font-black text-slate-700">312</span>
             </div>
             <div className="flex-1 px-3 flex flex-col items-center">
               <span className="text-[11px] font-bold text-[var(--color-primary)] mb-0.5">有效 91.7%</span>
               <div className="w-full h-[2px] bg-[var(--color-primary)]/20 relative"><div className="absolute left-0 top-0 h-full bg-[var(--color-primary)] w-full" /><div className="absolute right-0 top-1/2 -translate-y-1/2 w-1.5 h-1.5 border-t-2 border-r-2 border-[var(--color-primary)] rotate-45" /></div>
             </div>
             <div className="flex flex-col">
               <span className="text-[11px] text-[var(--color-primary)] font-bold mb-0.5">有效样本</span>
          ...
          <div className="flex flex-col flex-1 min-h-0 border border-slate-200 rounded-lg overflow-hidden shadow-xs bg-slate-50/50">
             ...
             <div className="bg-[#111318] px-3 py-1.5 flex items-center justify-between border-b border-slate-800 shrink-0">
                <div className="text-[#FFD600] text-[11px] xl:text-[11.5px] font-bold tracking-wider">
                   8项关键结果不是根因，而是4个待验证方向
                </div>
                <div className="flex gap-3 text-[11px] text-white/60 font-medium">
                   <span>M: 管理者</span>
                   <span>O: 运营人员</span>
                   <span>R: 业代</span>
                </div>
             ...
             <div className="grid grid-cols-4 divide-x divide-slate-200 flex-1 min-h-0">
                ...
                <div className="p-2 lg:p-2.5 flex flex-col justify-between h-full bg-white/60">
                   <div>
                      ...
                      <div className="text-[11px] text-slate-400 leading-tight">管理者异常下钻</div>
                   </div>
                   <div className="flex flex-col gap-1.5 mt-auto">
                      ...
                      <div className="bg-white border border-slate-200 p-1.5 rounded shadow-xs">
                         <div className="flex items-center gap-1.5 mb-1">
                            ...
                            <span className="text-[11px] font-bold text-white bg-slate-800 px-1 py-0.5 rounded-xs leading-none">M10</span>
                         </div>
                         <div className="text-[11px] lg:text-[11px] font-bold text-slate-700 leading-tight">需要查看3个及以上位置</div>
                      </div>
                      {/* M16 */}
                      <div className="bg-white border border-slate-200 p-1.5 rounded shadow-xs">
                         <div className="flex items-center gap-1.5 mb-1">
                            <span className="text-sm lg:text-base font-black text-slate-800 leading-none">64%</span>
                            <span className="text-[11px] font-bold text-white bg-slate-800 px-1 py-0.5 rounded-xs leading-none">M16</span>
                         </div>
                         <div className="text-[11px] lg:text-[11px] font-bold text-slate-700 leading-tight">难区分策略与执行问题</div>
                      </div>
                   </div>
                </div>
                ...
                <div className="p-2 lg:p-2.5 flex flex-col justify-between h-full bg-white/60">
                   <div>
                      ...
                      <div className="text-[11px] text-slate-400 leading-tight">运营配置与协调</div>
                   </div>
                   <div className="flex flex-col gap-1.5 mt-auto">
                      {/* O12 */}
                      <div className="bg-white border border-slate-200 p-1.5 rounded shadow-xs">
                         <div className="flex items-center gap-1.5 mb-1">
                            ...
                            <span className="text-[11px] font-bold text-white bg-slate-500 px-1 py-0.5 rounded-xs leading-none">O12</span>
                         </div>
                         <div className="text-[11px] lg:text-[11px] font-bold text-slate-700 leading-tight">使用企微或Excel补充状态</div>
                      </div>
                      {/* O14 */}
                      <div className="bg-white border border-slate-200 p-1.5 rounded shadow-xs">
                         <div className="flex items-center gap-1.5 mb-1">
                            <span className="text-sm lg:text-base font-black text-slate-800 leading-none">64%</span>
                            <span className="text-[11px] font-bold text-white bg-slate-500 px-1 py-0.5 rounded-xs leading-none">O14</span>
                         </div>
                         <div className="text-[11px] lg:text-[11px] font-bold text-slate-700 leading-tight">难区分提交与检核通过</div>
                      </div>
                   </div>
                </div>
                ...
                <div className="p-2 lg:p-2.5 flex flex-col justify-between h-full bg-white/60">
                   <div>
                      ...
                      <div className="text-[11px] text-slate-400 leading-tight">现场作业与举证</div>
                   </div>
                   <div className="flex flex-col gap-1.5 mt-auto">
                      {/* O18 */}
                      <div className="bg-white border border-slate-200 p-1.5 rounded shadow-xs">
                         <div className="flex items-center gap-1.5 mb-1">
                            ...
                            <span className="text-[11px] font-bold text-white bg-slate-500 px-1 py-0.5 rounded-xs leading-none">O18</span>
                         </div>
                         <div className="text-[11px] lg:text-[11px] font-bold text-slate-700 leading-tight">仍需人工解释举证标准</div>
                      </div>
                      {/* R13 */}
                      <div className="bg-white border border-slate-200 p-1.5 rounded shadow-xs">
                         <div className="flex items-center gap-1.5 mb-1">
                            <span className="text-sm lg:text-base font-black text-slate-800 leading-none">42%</span>
                            <span className="text-[11px] font-bold text-slate-900 bg-[#FFD600] px-1 py-0.5 rounded-xs leading-none">R13</span>
                         </div>
                         <div className="text-[11px] lg:text-[11px] font-bold text-slate-700 leading-tight">现场遇到拍照不合格</div>
                      </div>
                   </div>
                </div>
                ...
                <div className="p-2 lg:p-2.5 flex flex-col justify-between h-full bg-white/60">
                   <div>
                      ...
                      <div className="text-[11px] text-slate-400 leading-tight">退回审核与奖励</div>
                   </div>
                   <div className="flex flex-col gap-1.5 mt-auto">
                      {/* R15 */}
                      <div className="bg-white border border-slate-200 p-1.5 rounded shadow-xs">
                         <div className="flex items-center gap-1.5 mb-1">
                            ...
                            <span className="text-[11px] font-bold text-slate-900 bg-[#FFD600] px-1 py-0.5 rounded-xs leading-none">R15</span>
                         </div>
                         <div className="text-[11px] lg:text-[11px] font-bold text-slate-700 leading-tight">1天以上才知道结果</div>
                      </div>
                      {/* R17 */}
                      <div className="bg-white border border-slate-200 p-1.5 rounded shadow-xs">
                         <div className="flex items-center gap-1.5 mb-1">
                            <span className="text-sm lg:text-base font-black text-slate-800 leading-none">49%</span>
                            <span className="text-[11px] font-bold text-slate-900 bg-[#FFD600] px-1 py-0.5 rounded-xs leading-none">R17</span>
                         </div>
                         <div className="text-[11px] lg:text-[11px] font-bold text-slate-700 leading-tight">看不清审核与奖励进度</div>
                      </div>
                   </div>
                </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[#F8F9FA] rounded-lg relative overflow-hidden border border-slate-200/80 shadow-xs min-h-0">
          <div className="p-3.5 lg:p-4 flex justify-between items-start relative z-20 shrink-0">
            <div className="w-full">
              <h3 className="text-[11px] lg:text-[11px] font-bold text-[var(--color-primary)] tracking-[0.15em] uppercase mb-0.5">RESEARCH EVIDENCE</h3>
          ...
          <div className="flex-1 relative overflow-hidden flex items-start justify-center min-h-0">
            {/* Back Image (Manager) */}
            <div className="absolute top-4 left-[10%] w-[75%] h-[calc(100%-88px)] shadow-[0_12px_24px_rgba(0,0,0,0.1)] border border-slate-200 bg-white rounded-md overflow-hidden rotate-[-4deg] origin-bottom hover:rotate-[-6deg] transition-all hover:z-30 cursor-pointer group">
              ...
              <div className="absolute bottom-0 inset-x-0 bg-black/80 backdrop-blur-xs p-2.5 text-white">
                ...
                <div className="text-[11px] text-white/70">经营判断 / 异常定位 / 系统支持</div>
              </div>
            </div>

            {/* Middle Image (Ops) */}
            <div className="absolute top-8 right-[12%] w-[75%] h-[calc(100%-88px)] shadow-[0_12px_24px_rgba(0,0,0,0.12)] border border-slate-200 bg-white rounded-md overflow-hidden rotate-[3deg] origin-bottom hover:rotate-[5deg] transition-all hover:z-30 cursor-pointer group z-10">
              ...
              <div className="absolute bottom-0 inset-x-0 bg-black/80 backdrop-blur-xs p-2.5 text-white">
                ...
                <div className="text-[11px] text-white/70">活动配置 / 过程跟踪 / 异常处理</div>
              </div>
            </div>

            {/* Front Image (Sales) */}
            <div className="absolute top-12 left-[16%] w-[75%] h-[calc(100%-88px)] shadow-[0_16px_32px_rgba(0,0,0,0.15)] border-2 border-white bg-white rounded-md overflow-hidden rotate-[-1deg] origin-bottom hover:rotate-[-2deg] transition-all hover:z-30 cursor-pointer group z-20">
              <img src="/images/survey/sales.png" alt="业代问卷" className="w-full object-cover" />
              <div className="absolute bottom-0 inset-x-0 bg-[#1A1F36]/90 backdrop-blur-xs p-2.5 text-white border-l-3 border-[var(--color-primary)]">
                <div className="font-bold text-[13px] mb-0.5">业代 · 18 题</div>
                <div className="text-[11px] text-white/80">拜访规划 / 门店执行 / 激励反馈</div>
              </div>
            </div>
          </div>
        </div>
