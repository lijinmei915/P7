...
export default function TaskDecisionPage({ onBack }: { onBack?: () => void }) {
  const methodStrip = (
    <div className="flex items-center gap-4 bg-white/80 border border-slate-200/70 shadow-sm px-3.5 py-1.5 rounded-xl shrink-0">
      <div className="text-[10px] font-black text-[#1853FF] tracking-widest uppercase border-r border-slate-200 pr-3">Method</div>
    ...
    >
      {/* Layer 1: MACRO LEVEL (01-02 宏观大盘与报警断层) */}
        <div className="rounded-2xl p-2.5 lg:p-3 bg-white/85 backdrop-blur-xl border border-white shadow-[0_4px_20px_rgba(24,83,255,0.06)] relative overflow-hidden flex flex-col md:flex-row items-center gap-3 shrink-0">
          <div className="absolute top-0 left-0 bottom-0 w-1.5 bg-[#1853FF]"></div>
          
          <div className="flex items-center gap-3 shrink-0 md:w-56">
            <div className="w-7 h-7 rounded-xl bg-[#1853FF] text-white flex items-center justify-center font-black text-xs shadow-md shrink-0">
              L1
            </div>
            <div>
              <div className="text-[9px] font-black tracking-widest text-[#1853FF] uppercase">MACRO · 宏观大盘</div>
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-2.5 w-full">
            <div className="bg-[#F8FAFC] border border-slate-200/70 p-2 rounded-xl flex items-center justify-between">
              <div>
                <div className="text-[8px] font-bold text-slate-400 uppercase">S级战略战役异动</div>
                <div className="text-xs font-black text-slate-800 mt-0.5">夏季冰饮专案 (预算42%)</div>
              </div>
              <span className="bg-red-50 text-red-500 font-black text-[9px] px-2 py-0.5 rounded-full border border-red-200/50">
                ROI -18% (破红线)
              </span>
            </div>
            ...
            <div className="bg-[#F8FAFC] border border-slate-200/70 p-2 rounded-xl flex items-center justify-around text-center">
              <div>
                ...
                <div className="text-[8px] text-slate-400 font-bold">时间过1/3</div>
              </div>
              <div className="w-px h-6 bg-slate-200"></div>
              <div>
                <div className="text-xs font-black text-red-500">72%</div>
                <div className="text-[8px] text-slate-400 font-bold">费用已烧</div>
              </div>
              <div className="w-px h-6 bg-slate-200"></div>
              <div>
                <div className="text-xs font-black text-slate-700">需踩刹车</div>
                <div className="text-[8px] text-slate-400 font-bold">严重超耗</div>
              </div>
            </div>
            ...
            <div className="bg-amber-50/80 border border-amber-200/80 p-2 rounded-xl flex items-start gap-2">
              ...
              <div>
                ...
                <div className="text-[8px] text-amber-700 leading-snug mt-0.5">
        ...
        <div className="flex-1 grid grid-cols-12 gap-3 min-h-0">
          ...
          <div className="col-span-12 md:col-span-4 bg-white/85 backdrop-blur-xl border border-white rounded-2xl p-3 flex flex-col shadow-sm justify-between min-h-0">
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-[8px] font-black tracking-widest text-[#1853FF] uppercase">03 · 锁定异常范围</span>
                <span className="text-[8px] bg-slate-100 text-slate-500 font-bold px-1.5 py-0.5 rounded">多维切片</span>
              </div>
              <div className="text-xs font-black text-slate-800 mb-2">下钻大区，找出失血源头</div>

              <div className="space-y-1.5">
                <div className="p-1.5 rounded-lg bg-slate-50 border border-slate-100 flex justify-between text-[9px] text-slate-500">
                  <span>华北大区</span><span>费用77% / 销69% (正常)</span>
                </div>
                <div className="p-2 rounded-lg bg-[#1853FF]/10 border-2 border-[#1853FF] flex justify-between items-center text-[10px] font-black text-[#1853FF] shadow-sm">
            ...
            <div className="mt-2.5 p-2 rounded-xl bg-amber-50/70 border border-amber-200/70 flex items-start gap-1.5">
              ...
              <div>
                <div className="text-[8.5px] font-black text-amber-800">改版前痛点②：跨系统人肉拼接数据</div>
                <div className="text-[7.5px] text-amber-700 leading-tight mt-0.5">
          ...
          <div className="col-span-12 md:col-span-4 bg-white/85 backdrop-blur-xl border border-white rounded-2xl p-3 flex flex-col shadow-sm justify-between min-h-0">
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-[8px] font-black tracking-widest text-[#1853FF] uppercase">04 · 建立并列假设</span>
                <span className="text-[8px] bg-[#1853FF]/10 text-[#1853FF] font-bold px-1.5 py-0.5 rounded">归因假设树</span>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="p-1.5 rounded-lg bg-slate-50 border border-slate-200/60 flex items-center justify-between">
                  <div>
                    <div className="text-[9px] font-bold text-slate-700">假设 A：策略力度不匹配</div>
                    <div className="text-[7px] text-slate-400">竞品降价 / 折扣门槛偏高</div>
                  </div>
                  <span className="text-[7px] bg-slate-200 text-slate-600 px-1.5 py-0.5 rounded font-bold">待验</span>
                </div>

                <div className="p-1.5 rounded-lg bg-slate-50 border border-slate-200/60 flex items-center justify-between">
                  <div>
                    <div className="text-[9px] font-bold text-slate-700">假设 B：终端供货断货</div>
                    <div className="text-[7px] text-slate-400">经销商缺货无销量</div>
                  </div>
                  <span className="text-[7px] bg-slate-200 text-slate-600 px-1.5 py-0.5 rounded font-bold">待验</span>
                </div>

                <div className="p-1.5 rounded-lg bg-[#1853FF]/5 border border-[#1853FF]/20 flex items-center justify-between">
                  <div>
                    <div className="text-[9px] font-black text-[#1853FF]">假设 C：门店陈列质量作假</div>
                    <div className="text-[7px] text-slate-500">陈列未达标 / 虚假摆拍</div>
                  </div>
                  <span className="text-[7px] bg-[#1853FF] text-white px-1.5 py-0.5 rounded font-bold">重点</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-2.5 p-2 rounded-xl bg-amber-50/70 border border-amber-200/70 flex items-start gap-1.5">
              ...
              <div>
                <div className="text-[8.5px] font-black text-amber-800">改版前痛点③：归因全凭主观拍脑袋</div>
                <div className="text-[7.5px] text-amber-700 leading-tight mt-0.5">
          ...
          <div className="col-span-12 md:col-span-4 bg-white/85 backdrop-blur-xl border border-white rounded-2xl p-3 flex flex-col shadow-sm justify-between min-h-0">
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-[8px] font-black tracking-widest text-[#1853FF] uppercase">05 · 多维证据矩阵核对</span>
                <span className="text-[8px] bg-red-50 text-red-600 font-bold px-1.5 py-0.5 rounded border border-red-100">真凶锁定</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-1.5">
                <div className="p-1.5 rounded-lg bg-slate-50 border border-slate-100 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <span className="text-[7.5px] font-black text-slate-400">进销存</span>
                    <span className="text-[6.5px] text-slate-500 font-bold bg-slate-200 px-1 rounded">排除断货</span>
                  </div>
                  <div className="text-[8px] font-bold text-slate-700 mt-1">缺货率仅 8% (正常)</div>
                </div>

                <div className="p-1.5 rounded-lg bg-red-50/70 border border-red-200 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <span className="text-[7.5px] font-black text-red-500">重点店覆盖</span>
                    <span className="text-[6.5px] text-red-600 font-bold bg-red-100 px-1 rounded">致命漏洞</span>
                  </div>
                  <div className="text-[8px] font-black text-red-600 mt-1">A类店覆盖率仅 38%</div>
                </div>

                <div className="p-1.5 rounded-lg bg-slate-50 border border-slate-100 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <span className="text-[7.5px] font-black text-slate-400">打卡率</span>
                    <span className="text-[6.5px] text-emerald-600 font-bold bg-emerald-50 px-1 rounded">虚假繁荣</span>
                  </div>
                  <div className="text-[8px] font-bold text-slate-700 mt-1">提交率看似 86%</div>
                </div>

                <div className="p-1.5 rounded-lg bg-amber-50/70 border border-amber-200 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <span className="text-[7.5px] font-black text-amber-600">照片复核</span>
                    <span className="text-[6.5px] text-amber-700 font-bold bg-amber-100 px-1 rounded">人工盲区</span>
                  </div>
                  <div className="text-[8px] font-black text-amber-700 mt-1">34% 照片重复/假拍</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-2 p-2 rounded-xl bg-red-50/80 border border-red-200 flex items-start gap-1.5">
              ...
              <div>
                <div className="text-[8.5px] font-black text-red-800">改版前痛点④：证据链孤岛 · 人工复核失效</div>
                <div className="text-[7.5px] text-red-700 leading-tight mt-0.5">
        ...
        <div className="rounded-2xl p-2.5 lg:p-3 bg-[#1E293B] text-white shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center gap-4 shrink-0">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#1853FF] via-[#38BDF8] to-amber-500"></div>
          ...
          <div className="flex-1 w-full flex flex-col md:flex-row items-start md:items-center gap-3 border-b md:border-b-0 md:border-r border-slate-700/60 pb-3 md:pb-0 md:pr-4">
            ...
            <div className="flex-1">
              <div className="text-[9px] font-black text-[#38BDF8] uppercase tracking-wider">06 ACTION · 责权利交割动作</div>
              <div className="text-xs font-bold text-white mt-0.5">区经督导：24h内重新举证，停拨争议补贴</div>
              
              {/* Pain Point 5 */}
              <div className="flex items-center gap-1.5 text-[8px] text-amber-300 mt-1.5 bg-amber-500/10 border border-amber-500/20 px-2 py-0.5 rounded-md">
          ...
          <div className="w-full md:w-56 shrink-0 flex flex-col justify-center border-b md:border-b-0 md:border-r border-slate-700/60 pb-3 md:pb-0 md:pr-4">
            <div className="text-[9px] font-black text-slate-400 uppercase tracking-wider">07 CLOSE LOOP · 结果闭环</div>
            <div className="text-xs font-bold text-white mt-0.5">跟踪质量回升与ROI止跌</div>
            {/* Pain Point 6 */}
            <div className="text-[8px] text-amber-300 mt-1 flex items-center gap-1 bg-amber-500/10 border border-amber-500/20 px-1.5 py-0.5 rounded-md">
          ...
          <div className="w-full md:w-80 shrink-0">
            <div className="text-[9px] font-black text-[#38BDF8] tracking-widest uppercase flex items-center gap-1.5 mb-1">
              <Sparkles className="w-3.5 h-3.5 text-[#38BDF8]" />
              AS-IS DIAGNOSIS · 核心断层诊断
            </div>
            <p className="text-[10px] lg:text-[11px] font-medium text-white/90 leading-snug">
